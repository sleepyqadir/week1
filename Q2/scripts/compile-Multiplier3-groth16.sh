...
echo "Compiling Multiplier3.circom circuit"

# compile a circuit 

circom Multiplier3.circom --r1cs --wasm --sym -o Multiplier3

# logging circuit info ==> Constraints , Inputs , Outputs and Wires 
...
snarkjs zkey contribute Multiplier3/circuit_0000.zkey Multiplier3/circuit_final.zkey --name="AbdulQadir" -v -e="Deep Work"
snarkjs zkey export verificationkey Multiplier3/circuit_final.zkey Multiplier3/verificationkey.json

# generate a verifierContract  
